...
![Screen de l'exécution de la commande file sur l'image!](/SteakHacheDansLaForet/assets/images/file_steak-hache.png "Exécution de la commande file sur l'image")

Deuxième réflexe, on regarde métadata du fichier pour obtenir un maximum d'informations sur celui-ci :
![Screen de l'exécution de la commande exiftool sur l'image!](/SteakHacheDansLaForet/assets/images/exiftool_steak-hache.png "Exécution de la commande exiftool sur l'image")
...
Il est possible d'obtenir encore plus d'informations en utilisant des solutions comme Aperi'Solve ou forensically :
	...
	![Screen de l'exécution des résultats d'aperisolve sur l'image!](/SteakHacheDansLaForet/assets/images/aperisolve_steak-hache.png "Exécution d'aperisolve sur l'image")
...
![Screen de l'exécution de la commande steghide sur l'image!](/SteakHacheDansLaForet/assets/images/steghide_steak-hache.png "Exécution de la commande steghide sur l'image")

Un fichier "flag.txt" a été créé. Il nous suffit de lire son contenu pour obtenir le flag :
![Screen de l'exécution de la commande cat sur le fichier flag.txt!](/SteakHacheDansLaForet/assets/images/cat_flag.png "Exécution de la commande cat sur le fichier flag.txt")